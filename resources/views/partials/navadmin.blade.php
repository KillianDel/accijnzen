<header class="navbar navbar-dark fixed-top bg-success flex-md-nowrap p-0 shadow">
    <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="/">
        <img src="{{ asset('media/logo.png') }}" alt="Turnsport Verbroedering" width="110" height="50">
      </a>
...
<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
    <div class="position-sticky pt-4">
      <ul class="nav flex-column">
        ...
        <li class="nav-item">
          <a class="nav-link {{ request()->is('dashboard/cursussen') ? 'active' : '' }}" href="">
            <span data-feather="sunset"></span>
            Cursussen
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link {{ request()->is('dashboard/contact') ? 'active' : '' }}" href="">
            <span data-feather="sunset"></span>
            Contact
          </a>
        </li>
